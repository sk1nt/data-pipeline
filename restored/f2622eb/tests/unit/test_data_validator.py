...
class TestDataValidator:
    ...
    def test_timestamp_range_validation(self):
        ...
        # Invalid: too early
        assert not validator.validate_timestamp(datetime(2023, 12, 31), start_date, end_date)

        # Invalid: too late
        assert not validator.validate_timestamp(datetime(2024, 2, 1), start_date, end_date)
    ...
    def test_duplicate_detection(self):
        ...
        records = [
            ...
            {'timestamp': datetime(2024, 1, 1, 12, 0, 0), 'price': 4500.00},  # Duplicate
    ...
    def test_data_consistency_validation(self):
        ...
        # Valid data
        valid_data = {
            'tick_timestamps': [datetime(2024, 1, 1, 12, 0, 0), datetime(2024, 1, 1, 12, 0, 1)],
            'depth_timestamps': [datetime(2024, 1, 1, 12, 0, 0), datetime(2024, 1, 1, 12, 0, 1)]
        }
