...
- [ ] T012 [US1] Implement GEX payload validation and processing in src/data-pipeline.py
- [ ] T013 [US1] Implement DuckDB persistence for GEX snapshots and strikes in src/data-pipeline.py
...
- [ ] T027 [US3] Implement webhook payload validation and processing in src/data-pipeline.py
- [ ] T028 [US3] Implement DuckDB persistence for webhook data in src/data-pipeline.py
