...
class Config:
    # Database
    DATABASE_PATH: str = os.path.join(os.path.dirname(__file__), '../../data/tick_data.db')
    ...
    # Data sources
    SIERRA_CHART_ENABLED: bool = os.getenv('SIERRA_CHART_ENABLED', 'false').lower() == 'true'
    ...
    COMPRESSION_INTERVAL_MINUTES: int = int(os.getenv('COMPRESSION_INTERVAL_MINUTES', '60'))
