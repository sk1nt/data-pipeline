...
class GEXImporter:
    ...
    def _convert_gex_bridge_format(self, snapshot_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        for strike_item in snapshot_data['strikes']:
            if len(strike_item) >= 4:
                strike_price, vol_gex, oi_gex, priors = strike_item[0], strike_item[1], strike_item[2], strike_item[3]
    ...
    def import_snapshot(self, snapshot: GEXSnapshot, dry_run: bool = False) -> Dict[str, Any]:
