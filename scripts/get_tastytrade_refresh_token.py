...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Retrieve a new TastyTrade refresh token (interactive)"
    )
    parser.add_argument(
        "--sandbox", action="store_true", help="Use TastyTrade sandbox environment"
    )
...
def main():
    args = parse_args()
    print(
        "Starting OAuth flow; browser will open. Copy the printed refresh_token and update your .env"
    )
